# Erreferentzia: http://www.starzel.de/blog/securing-plone-sites-with-https-and-nginx
...
server {
       ...
       access_log /var/log/nginx/${configuration:server-name}.log;
       error_log  /var/log/nginx/${configuration:server-name}.log;
...
server {
       ...
       access_log /var/log/nginx/${configuration:edit-server-name}_access.log;
       error_log  /var/log/nginx/${configuration:edit-server-name}_error.log;
